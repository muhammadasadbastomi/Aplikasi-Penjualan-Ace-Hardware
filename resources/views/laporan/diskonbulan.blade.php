...
<head>
    ...
    <title>Laporan Data Barang Diskon Aktif Bulan Ini</title>
...
<body>
    ...
    <div class="container" style="margin-top:-40px;">
        <h3 style="text-align:center;text-transform: uppercase;">Laporan Data Barang Diskon Aktif Pada Bulan {{$now}}</h3>
