                                ...
                                <div class="card-body pt-1">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <fieldset class="form-label-group form-group position-relative has-icon-left">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" placeholder="E-Mail" required autocomplete="email" autofocus>
                                        ...
                                        <button type="submit" class="btn btn-primary float-right btn-inline" style="width: 100%;">Login</button>
                                    </form>
                                </div>
                            </div>
                            <br><br>
