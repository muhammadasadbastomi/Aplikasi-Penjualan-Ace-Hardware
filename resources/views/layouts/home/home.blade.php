    ...
    <footer class="footer footer-static footer-light navbar-shadow">
        <div class="d-flex flex-row">
            <div class="col-md-3 col-sm-12">
                <h5 class="footer-heading" style="padding-left:35px; margin-bottom:14px; font-size:12px;"><b><i
                            class="feather icon-map-pin"></i> Location</b>
                </h5>
                <div class="footer-section">
                    <ul class="footer-navs"
                        style="list-style-position: outside; list-style-type:none;   line-height: 2;">
                        <li>
            ...
            <section class="col-md-3 col-sm-12">
                <h5 class="footer-heading" style="padding-left:35px; margin-bottom:14px; font-size:13px;"><b><i
                            class="feather icon-phone-call"></i> Customer Service</b>
                </h5>
                <div class="footer-section">
                    <ul class="footer-navs" style="list-style-position: outside; list-style-type:none;">
                        <li>
                            <a style="color: black;" href="https://www.acehardware.co.id/service-center"
                                target="">Service Center</a>
                        </li>
                        <li>
            ...
            <section class="col-md-3 col-sm-12">
                <h5 class="footer-heading" style="padding-left:35px; margin-bottom:14px; font-size:13px;"><b><i
                            class="feather icon-phone-incoming"></i> Call Center</b>
                </h5>
                <div class="footer-section">
                    <ul class="footer-navs" style="list-style-position: outside; list-style-type:none;">
                        <li>
            ...
            <section class="col-md-3 col-sm-12">
                <h5 class="footer-heading" style="padding-left:35px; margin-bottom:14px; font-size:13px;"><b><i
                            class="feather icon-wifi"></i> Social Media</b>
                </h5>
                <div class="footer-section">
                    <ul class="footer-navs" style="list-style-position: outside; list-style-type:none;">
                        <div class="social-medias">
                            <a style="color: black;" class="social-media --fb"
                                href="https://www.facebook.com/aceindonesia" target="blank">
                                <div class="badge badge-success mr-1 mb-1">
                                    <i class="ficon feather icon-facebook"></i>
                                </div>
                            </a>
                            <a style="color: black;" class="social-media --tw" href="https://twitter.com/aceindonesia"
                                target="blank">
                                <div class="badge badge-info mr-1 mb-1">
                                    <i class="ficon feather icon-twitter"></i>
                                </div>
                            </a>
                            <a style="color: black;" class="social-media --ig"
                                href="https://www.instagram.com/aceindonesia" target="blank">
                                <div class="badge badge-warning mr-1 mb-1">
                                    <i class="ficon feather icon-instagram"></i>
                                </div>
                            </a>
                            <a style="color: black;" class="social-media --yt"
                                href="https://www.youtube.com/channel/UCPfmCvkq7qpNqqwJ_2OoCzQ" target="blank">
