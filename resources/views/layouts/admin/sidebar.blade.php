...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item"> <a href="{{route('adminIndex')}}"><i class="feather icon-home"></i><span
            ...
            <li class="nav-item"><a href="#"><i class="feather icon-server "></i><span class="menu-title">Master
                ...
                <ul class="menu-content">
                    <li><a href="{{ route('thumbIndex') }}"><i class="feather icon-circle"></i><span class="menu-item"
                                data-i18n="eCommerce">Thumbnail</span></a></li>
            ...
            <li class="nav-item"><a href="#"><i class="feather icon-package"></i><span
                        class="menu-title">Pengelolaan</span></a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href="{{route('userEdit')}}"><i class="feather icon-settings"></i><span
                        class="menu-title" data-i18n="Account Settings">Edit Profile</span></a>
            </li>
            ...
            <li class="nav-item"><a href="#"><i class="feather icon-users"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a href="{{route('userAdmin')}}"><i class="feather icon-circle"></i><span class="menu-item"
                                data-i18n="List">Admin</span></a>
                    </li>
                    <li><a href="{{route('userKaryawan')}}"><i class="feather icon-circle"></i><span class="menu-item"
