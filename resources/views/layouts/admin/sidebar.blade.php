...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item {{ (\Request::route()->getName() == 'adminIndex') ? 'active' : '' }}"> <a href="{{route('adminIndex')}}"><i class="feather icon-home"></i><span class="menu-title">Dashboard</span></a></li>
            <li class="nav-item"><a href="#"><i class="feather icon-server "></i><span class="menu-title">Master
                        Data</span></a>
                <ul class="menu-content">
                    <li class="{{ (\Request::route()->getName() == 'thumbIndex') ? 'active' : '' }}"><a href="{{ route('thumbIndex') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">Thumbnail</span></a></li>
            ...
            <li class="nav-item {{ (request()->is('barang')) ? 'active' : '' }}"><a href="#"><i class="feather icon-package"></i><span class="menu-title">Pengelolaan</span></a>
                <ul class="menu-content">
                    <li class="{{ (\Request::route()->getName() == 'datangIndex') ? 'active' : '' }}"><a href="{{ route('datangIndex') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">Barang Datang</span></a></li>
                    <li class="{{ (\Request::route()->getName() == 'terjualIndex') ? 'active' : '' }}"><a href="{{ route('terjualIndex') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">Barang Terjual</span></a></li>
                    <li class="{{ (\Request::route()->getName() == 'garansiIndex') ? 'active' : '' }}"><a href="{{ route('garansiIndex') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="eCommerce">Barang Garansi</span></a></li>
            ...
            <li class="nav-item "><a href="#"><i class="feather icon-users"></i><span class="menu-title" data-i18n="User">User</span></a>
                <ul class="menu-content">
                    <li class="{{ (\Request::route()->getName() == 'userAdmin') ? 'active' : '' }}"><a href="{{route('userAdmin')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="List">Admin</span></a>
                    </li>
                    <li class="{{ (\Request::route()->getName() == 'userKaryawan') ? 'active' : '' }}"><a href="{{route('userKaryawan')}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="View">Karyawan</span></a>
                    </li>
                </ul>
            </li>
            @else
