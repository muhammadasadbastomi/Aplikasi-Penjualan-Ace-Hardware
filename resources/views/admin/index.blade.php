                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                ...
                                <hr>
                                <a href="{{route('supplierIndex')}}" type="button" class="btn btn-flat-default round border-black text-default mr-1 mb-1 waves-effect waves-light" style="width: 100%;"> <i class="feather icon-users text-default font-medium-2"></i> Lihat Data</a>
                            </div>
                            <br>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar-content" style="margin-left:3px;">
                                    <h4> <i class="feather icon-package text-info font-medium-5"></i> &emsp14; <a href="{{route('datangIndex')}}" class="mb-0" style="color:black;" style="color:black;">Barang Datang</a></h4>
                                </div>
                                <h5 class="text-bold-700 mt-1 mb-25">@if(empty(totaldatang())) Belum Ada Data Barang Datang @else Total : {{totaldatang()}} <br><br> Barang @endif</h5>
                                <hr>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar-content" style="margin-left:3px;">
                                    <h4> <i class="feather icon-package text-success font-medium-5"></i> &emsp14; <a href="{{route('terjualIndex')}}" class="mb-0" style="color:black;" style="color:black;">Barang Terjual</a></h4>
                                </div>
                                <h5 class="text-bold-700 mt-1 mb-25">@if(empty(totalterjual())) Belum Ada Data Barang Terjual @else Total : {{totalterjual()}} <br><br> Barang @endif</h5>
                                <hr>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar-content" style="margin-left:3px;">
                                    <h4> <i class="feather icon-package text-danger font-medium-5"></i> &emsp14; <a href="{{route('garansiIndex')}}" class="mb-0" style="color:black;" style="color:black;">Barang Garansi</a></h4>
                                </div>
                                <h5 class="text-bold-700 mt-1 mb-25">@if(empty(totalgaransi())) Tidak Ada Data Barang Garansi @else Total : {{totalgaransi()}} <br><br> Barang @endif</h5>
                                <hr>
                                <a href="{{route('garansiIndex')}}" type="button" class="btn btn-flat-danger round border-danger  mr-1 mb-1 waves-effect waves-light" style="width: 100%;"> <i class="feather icon-package  font-medium-2"></i> Lihat Data</a>
                            </div>
                            <br>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar-content" style="margin-left:3px;">
                                    <h4> <i class="feather icon-package text-warning font-medium-5"></i> &emsp14; <a href="{{route('rusakIndex')}}" class="mb-0" style="color:black;" style="color:black;">Barang Rusak</a></h4>
                                </div>
                                <h5 class="text-bold-700 mt-1 mb-25">@if(empty(totalrusak())) Tidak ada Data Barang Rusak @else Total : {{totalrusak()}} <br><br> Barang @endif</h5>
                                <hr>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-column align-items-start pb-0">
                                <div class="avatar-content" style="margin-left:3px;">
                                    <h4> <i class="feather icon-package text-default font-medium-5"></i> &emsp14; <a href="{{route('pengirimanIndex')}}" class="mb-0" style="color:black;" style="color:black;">Pengiriman</a></h4>
                                </div>
                                <h5 class="text-bold-700 mt-1 mb-25">@if(empty(totalpengiriman())) Tidak ada Barang Pengiriman @else Total : {{totalpengiriman()}} <br><br> Barang @endif</h5>
                                <hr>
                                <a href="{{route('pengirimanIndex')}}" type="button" class="btn btn-flat-default round border-black  mr-1 mb-1 waves-effect waves-light" style="width: 100%;"> <i class="feather icon-package  font-medium-2"></i> Lihat Data</a>
                            </div>
                            <br>
                        </div>
                    </div>
