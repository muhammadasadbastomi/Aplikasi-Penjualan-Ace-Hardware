                            ...
                            <div class="card-header">
                                ...
                                <div class="dt-buttons btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" target="_blank" href="{{route('etalaseCetak')}}">Keseluruhan</a>
                                        <a class="dropdown-item" target="_blank" href="{{route('etalasebulanCetak')}}">Berdasarkan Etalase Aktif Bulan Ini</a>
                                    </div>
