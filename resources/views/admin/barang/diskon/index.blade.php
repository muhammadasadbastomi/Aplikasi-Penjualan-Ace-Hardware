...
@section('title') Admin Data Barang Diskon @endsection
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Data Barang Diskon</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Home</a>
                                </li>
                                <li class="breadcrumb-item active">Data Barang Diskon
                                </li>
                            </ol>
                        </div>
                    </div>
...
<script>
    $(document).on('click', '.delete', function(e) {
        ...
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "{{ url('/admin/barang/diskon/delete')}}" + '/' + id,
                    type: "POST",
                    data: {
                        '_method': 'DELETE',
                        "_token": "{{ csrf_token() }}"
