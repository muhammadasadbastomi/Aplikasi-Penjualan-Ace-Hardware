                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nama"
                                ...
                                placeholder="Masukkan Nama Pembeli" name="nama_pembeli" value="{{old('nama_pembeli')}}">
                            @error('nama_pembeli')<div class="invalid-feedback"> {{$message}} </div>@enderror
                        </div>
                        <div class="form-group">
                            <label for="email">E-Mail</label>
                            <input type="email" placeholder="Masukkan E-Mail" id="email"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="telp" class="form-control  @error ('telp') is-invalid @enderror"
                                name="telp" placeholder="Masukkan Nomor Telepon" value="{{old('telp')}}">
