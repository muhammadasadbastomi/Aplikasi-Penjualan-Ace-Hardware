            ...
            <div class="modal-body">
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="date" name="tgl_pembelian" id="tgl_pembelian" value="{{old('tgl_pembelian')}}" class="form-control  @error ('tgl_pembelian') is-invalid @enderror">
                            @error('tgl_pembelian')<div class="invalid-feedback"> {{$message}} </div>@enderror
                        </div>

                        <label>Tanggal Akhir Garansi</label>
                        <div class="form-group">
                            <input type="date" name="tgl_akhir_garansi" id="tgl_akhir_garansi" value="{{old('tgl_akhir_garansi')}}" class="form-control  @error ('tgl_akhir_garansi') is-invalid @enderror">
                            @error('tgl_akhir_garansi')<div class="invalid-feedback"> {{$message}} </div>@enderror
                        </div>
